...
const items = [
  ...
  { to: "/admin/payouts", label: "Rider payouts", icon: Wallet, exact: false, adminOnly: true },
  ...
  { to: "/admin/rider-assignment", label: "Rider assignment", icon: Bike, exact: false, adminOnly: false },
  { to: "/admin/assignment-history", label: "Assignment history", icon: LineChart, exact: false, adminOnly: false },
] as const;
