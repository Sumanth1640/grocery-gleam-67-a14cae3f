  ...
  return (
    <div className="relative flex flex-col rounded-3xl bg-card p-3 shadow-card">
      ...
      <Link
        ...
        className="grid aspect-square place-items-center overflow-hidden rounded-2xl bg-[oklch(0.97_0.01_145)]"
      >
        <img src={product.image} alt={product.name} loading="lazy" className="h-[88%] w-[88%] object-contain" />
      </Link>
