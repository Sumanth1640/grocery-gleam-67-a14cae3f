...
import { Loader2, MapPin, ShoppingBag, UtensilsCrossed } from "lucide-react";
import { myManagedOutlets, listOutletOrders } from "@/lib/outlet-managers.functions";
            ...
            <li key={m.id} className="rounded-2xl border bg-card p-4 shadow-card">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-sm font-semibold">{m.outlet?.name}</div>
