...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Order fresh farm vegetables, fruits, dairy and household essentials online. Hand-picked daily and delivered to your door." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "HalliFresh Veggies — Fresh from Farm to Home" },
      { name: "twitter:description", content: "Order fresh farm vegetables, fruits, dairy and household essentials online. Hand-picked daily and delivered to your door." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e23e5860-b6b2-48cd-9df5-b621fc04aa78/id-preview-3cfae270--16b78db9-75c1-4d38-8381-401bfdad3cb0.lovable.app-1779701134864.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e23e5860-b6b2-48cd-9df5-b621fc04aa78/id-preview-3cfae270--16b78db9-75c1-4d38-8381-401bfdad3cb0.lovable.app-1779701134864.png" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700;800&family=Figtree:wght@400;500;600;700&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap",
      },
    ],
  }),
