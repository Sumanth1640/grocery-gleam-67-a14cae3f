...
export const Route = createFileRoute("/food/checkout")({
  head: () => ({ meta: [{ title: "Food checkout — hallifresh" }] }),
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 md:py-10">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-[1fr_360px]">
          ...
          <aside className="h-fit rounded-2xl border bg-card p-5 shadow-card md:sticky md:top-20">
            ...
            {couponData && (
              <div className="mt-3 inline-flex items-center gap-1.5 rounded-md bg-success/10 px-2 py-1 text-[11px] font-bold text-success">
                <Tag className="h-3 w-3" /> {couponData.code} applied
              </div>
            )}
