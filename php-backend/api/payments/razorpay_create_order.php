...
$key_id     = getenv('RAZORPAY_KEY_ID')     ?: (defined('RAZORPAY_KEY_ID')     ? RAZORPAY_KEY_ID     : '');
$key_secret = getenv('RAZORPAY_KEY_SECRET') ?: (defined('RAZORPAY_KEY_SECRET') ? RAZORPAY_KEY_SECRET : '');
if (!$key_id || !$key_secret) json_error('Razorpay keys not configured on server', 500);
